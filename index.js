...
//jwt for the first time: everything is okay this code commented for another practice
// const verifyJWT = (req, res, next) => {
//   console.log('hitting jwt verify JWT');
...
//jwt explore again with same certain
const verifyJWT =(req, res, next)=>{
const authorization = req.headers.authorization;
if(!authorization){
  return res.status(401).send({error: true, message: 'unauthorized access'})
...
async function run() {
  try {
    ...
    app.get('/bookings', verifyJWT, async (req, res) => {
      ...
      console.log('comeback from jwt verify', decoded)
